...
from keanu.abilities.seeing.detect import detect, SynthesisReading, DETECTORS
...
from keanu.abilities.world.compress import ContentDNS, COEFStack, COEFSpanExporter
